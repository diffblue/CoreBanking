...
class CashTransactionDiffblueTest {
  ...
  void testNewCashTransaction_whenMinusOne_thenReturnSourceIs1234567890() {
    ...
    // Act
    CashTransaction actualCashTransaction = new CashTransaction(-1L, date, targetAccount);
  ...
  void testNewCashTransaction_whenTen_thenReturnTargetIs1234567890() {
    ...
    // Act
    CashTransaction actualCashTransaction = new CashTransaction(10L, date, targetAccount);
  ...
  void testGetSource_thenReturn1234567890() {
    ...
    CashTransaction cashTransaction = new CashTransaction(-1L, date, targetAccount);

    // Act and Assert
    assertEquals("1234567890", cashTransaction.getSource());
  }
  ...
  void testGetSource_thenReturnCash() {
    ...
    // Act and Assert
    assertEquals("CASH", cashTransaction.getSource());
  }
  ...
  void testGetTarget_thenReturn1234567890() {
    ...
    // Act and Assert
    assertEquals("1234567890", cashTransaction.getTarget());
  }
  ...
  void testGetTarget_thenReturnCash() {
    ...
    // Act and Assert
    assertEquals("CASH", cashTransaction.getTarget());
  }
  ...
  void testExecuteTransaction3() throws TransactionException {
    ...
    CashTransaction cashTransaction = new CashTransaction(Long.MIN_VALUE, date, targetAccount);
