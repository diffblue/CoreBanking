...
class BankTransactionDiffblueTest {
  ...
  void testNewBankTransaction() {
    ...
    Account targetAcc = new Account(1234567890L, new Client("Dr Jane Doe"), 10L);

    // Act
    BankTransaction actualBankTransaction = new BankTransaction(10L, date, sourceAcc, targetAcc);
  ...
  void testGetSource_thenReturn1234567890() {
    ...
    BankTransaction bankTransaction = new BankTransaction(10L, date, sourceAcc, targetAcc);

    // Act and Assert
    assertEquals("1234567890", bankTransaction.getSource());
  }
  ...
  void testGetTarget_thenReturn1234567890() {
    ...
    // Act and Assert
    assertEquals("1234567890", bankTransaction.getTarget());
  }
  ...
  void testExecuteTransaction_thenThrowTransactionException() throws TransactionException {
    ...
    BankTransaction bankTransaction =
        new BankTransaction(Long.MAX_VALUE, date, sourceAcc, targetAcc);

    // Act and Assert
    assertThrows(TransactionException.class, () -> bankTransaction.executeTransaction());
  }
}
